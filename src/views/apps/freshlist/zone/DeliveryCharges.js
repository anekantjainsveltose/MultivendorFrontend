          ...
          return (
            <div className="actions cursor-pointer">
              <Edit
                ...
                onClick={() =>
                  history.push(
                    `/app/freshlist/zone/editDeliveryCharges/${params.data._id}`
                  )
                }
              />
              <Trash2
              ...
              <Row className="m-2">
                ...
                <Col>
                  <Button
                    ...
                    onClick={() =>
                      history.push("/app/freshlist/zone/DeliveryChargesList")
                    }
                  >
                    Back
                  </Button>
                  ...
                  <Route
                    render={({ history }) => (
                      <Button
                        className="btn btn-danger float-right"
                        onClick={() =>
                          history.push("/app/freshlist/zone/AddDeliveryCharges")
                        }
                      >
                        Add New
                      </Button>
