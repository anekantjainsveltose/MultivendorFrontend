...
class DeliverySlots extends React.Component {
  state = {
    rowData: [],
          ...
          return (
            <div className="actions cursor-pointer">
              <Edit
                ...
                onClick={() =>
                  history.push(
                    `/app/freshlist/zone/editDeliverySlots/${params.data._id}`
                  )
                }
              />
              <Trash2
              ...
              <Row className="m-2">
                ...
                <Col>
                  <Button
                    ...
                    onClick={() =>
                      history.push("/app/freshlist/zone/DeliverySlots")
                    }
                  >
                    Back
                  </Button>
                  ...
                  <Route
                    render={({ history }) => (
                      <Button
                        className="btn btn-danger float-right"
                        onClick={() =>
                          history.push("/app/freshlist/zone/AddDeliverySlots")
                        }
                      >
                        Add New
                      </Button>
