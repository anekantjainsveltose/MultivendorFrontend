...
class ZoneBasedProducts extends React.Component {
  state = {
    rowData: [],
          ...
          return (
            <div className="actions cursor-pointer">
              <Edit
                ...
                onClick={() =>
                  history.push(
                    `/app/freshlist/zone/editZoneBasedProducts/${params.data._id}`
                  )
                }
              />
              <Trash2
              ...
              <Row className="m-2">
                ...
                <Col>
                  <Button
                    ...
                    onClick={() =>
                      history.push("/app/freshlist/zone/ZoneBasedProduct")
                    }
                  >
                    Back
                  </Button>
                  ...
                  <Route
                    render={({ history }) => (
                      <Button
                        ...
                        onClick={() =>
                          history.push(
                            "/app/freshlist/zone/AddZoneBasedProducts"
                          )
                        }
                      >
                        Add New
...
export default ZoneBasedProducts;
