              ...
              <Route
                render={({ history }) => (
                  <Eye
                    ...
                    onClick={() =>
                      history.push(
                        `/app/freshlist/role/ViewRole/${params.data._id}`
                      )
                    }
                  />
                )}
              ...
              <Route
                render={({ history }) => (
                  <Edit
                    ...
                    onClick={() =>
                      history.push(
                        `/app/freshlist/role/EditRole/${params.data._id}`
                      )
                    }
                  />
                )}
              ...
              <Row className="m-2">
                ...
                <Col>
                  <Button
                    ...
                    onClick={() => history.push("/app/freshlist/role/RoleList")}
                  >
                    Back
                  </Button>
                </Col>
                  ...
                  <Route
                    render={({ history }) => (
                      <Button
                        ...
                        color="primary"
                        onClick={() =>
                          history.push("/app/freshlist/role/AddRole")
                        }
                      >
                        Add Role
                      </Button>
