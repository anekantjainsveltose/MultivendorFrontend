              ...
              <Route
                render={({ history }) => (
                  <Eye
                    ...
                    onClick={() =>
                      history.push(
                        `/app/freshlist/stock-returns/ViewStockReturn/${params.data._id}`
                      )
                    }
                  />
                )}
              ...
              <Route
                render={({ history }) => (
                  <Edit
                    ...
                    onClick={() =>
                      history.push(
                        `/app/freshlist/stock-returns/EditStockReturn/${params.data._id}`
                      )
                    }
                  />
                )}
              ...
              <Row className="m-2">
                ...
                <Col>
                  <Button
                    ...
                    onClick={() =>
                      history.push(
                        "/app/freshlist/stock-returns/StockReturnList"
                      )
                    }
                  >
                    Back
                  ...
                  <Route
                    render={({ history }) => (
                      <Button
                        ...
                        onClick={() =>
                          history.push(
                            "/app/freshlist/stock-returns/AddStockReturn"
                          )
                        }
                      >
                        Add Stock Return
