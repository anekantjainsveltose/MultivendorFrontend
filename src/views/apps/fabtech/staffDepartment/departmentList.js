                ...
                render={({ history }) => (
                  <>
                    <Eye
                      ...
                      onClick={() =>
                        history.push(
                          `/app/freshlist/staff/department/viewDepartment/${params.data._id}`
                        )
                      }
                    />
                    ...
                    <Edit
                      ...
                      onClick={() =>
                        history.push(
                          `/app/freshlist/staff/department/editDepartment/${params.data._id}`
                        )
                      }
                    />
                  </>
                  ...
                  <Route
                    render={({ history }) => (
                      <Button
                        ...
                        color="primary"
                        onClick={() =>
                          history.push("/app/freshlist/staff/department/addDepartment")
                        }
                      >
                        Add New
                      </Button>
