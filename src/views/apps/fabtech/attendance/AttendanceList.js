                ...
                render={({ history }) => (
                  <>
                    <Eye
                      ...
                      onClick={() =>
                        history.push(
                          `/app/freshlist/attendance/viewAttedance/${params.data._id}`
                        )
                      }
                    />
                    <Edit
                      ...
                      onClick={() =>
                        history.push(
                          `/app/freshlist/attendance/editAttendance/${params.data._id}`
                        )
                      }
                    />
                    <Trash2
                  ...
                  <Route
                    render={({ history }) => (
                      <Button
                        ...
                        color="primary"
                        onClick={() =>
                          history.push("/app/freshlist/attendance/addAttendance")
                        }
                      >
                        Add New
                      </Button>
