...
export default class EditStockTransfer extends Component {
  constructor(props) {
    super(props);
    this.state = {
      name: "",
    ...
    return (
      <div>
        <Card>
          <Row className="m-2">
            <Col>
              <h1 className="float-left">Edit Stock Transfer </h1>
            </Col>
            <Col>
              <Route
                render={({ history }) => (
            ...
            <Form className="m-1" onSubmit={this.submitHandler}>
              <Row>
                <Col lg="5" md="5" className="ml-2">
                  <FormGroup>
                    <Label>Stock Transfer Name</Label>
                    <Input
                      type="text"
                      placeholder="Stock Transfer Name"
                      name="username"
