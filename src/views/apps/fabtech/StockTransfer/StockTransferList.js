              ...
              <Route
                render={({ history }) => (
                  <Eye
                    ...
                    onClick={() =>
                      history.push(
                        `/app/freshlist/stock-transfer/ViewStockTransfer/${params.data._id}`
                      )
                    }
                  />
                )}
              ...
              <Route
                render={({ history }) => (
                  <Edit
                    ...
                    onClick={() =>
                      history.push(
                        `/app/freshlist/stock-transfer/EditStockTransfer/${params.data._id}`
                      )
                    }
                  />
                )}
              ...
              <Row className="m-2">
                ...
                <Col>
                  <Button
                    ...
                    onClick={() =>
                      history.push(
                        "/app/freshlist/stock-transfer/StockTransferList"
                      )
                    }
                  >
                    Back
                  ...
                  <Route
                    render={({ history }) => (
                      <Button
                        ...
                        onClick={() =>
                          history.push(
                            "/app/freshlist/stock-transfer/AddStockTransfer"
                          )
                        }
                      >
                        Add Stock Transfer
