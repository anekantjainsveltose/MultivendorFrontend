              ...
              <Route
                render={({ history }) => (
                  <Eye
                    ...
                    onClick={() =>
                      history.push(
                        `/app/freshlist/permission/ViewPermission/${params.data._id}`
                      )
                    }
                  />
                )}
              ...
              <Route
                render={({ history }) => (
                  <Edit
                    ...
                    onClick={() =>
                      history.push(
                        `/app/freshlist/permission/EditPermission/${params.data._id}`
                      )
                    }
                  />
                )}
              ...
              <Row className="m-2">
                ...
                <Col>
                  <Button
                    ...
                    onClick={() =>
                      history.push("/app/freshlist/permission/PermissionList")
                    }
                  >
                    Back
                  </Button>
                  ...
                  <Route
                    render={({ history }) => (
                      <Button
                        ...
                        onClick={() =>
                          history.push(
                            "/app/freshlist/permission/AddPermission"
                          )
                        }
                      >
                        Add Permission
