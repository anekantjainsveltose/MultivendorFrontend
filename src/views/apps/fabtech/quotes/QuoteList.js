              ...
              <Route
                render={({ history }) => (
                  <Eye
                    ...
                    onClick={() =>
                      history.push(
                        `/app/freshlist/quote/ViewQuote/${params.data._id}`
                      )
                    }
                  />
                )}
              ...
              <Route
                render={({ history }) => (
                  <Edit
                    ...
                    onClick={() =>
                      history.push(
                        `/app/freshlist/quote/EditQuote/${params.data._id}`
                      )
                    }
                  />
                )}
              ...
              <Row className="m-2">
                ...
                <Col>
                  <Button
                    ...
                    onClick={() =>
                      history.push("/app/freshlist/quote/QuoteList")
                    }
                  >
                    Back
                  </Button>
                  ...
                  <Route
                    render={({ history }) => (
                      <Button
                        ...
                        color="primary"
                        onClick={() =>
                          history.push("/app/freshlist/quote/AddQuote")
                        }
                      >
                        Add Quote
                      </Button>
