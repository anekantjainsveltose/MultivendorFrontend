/*! For license information please see 203.1a6e1286.chunk.js.LICENSE.txt */
    ...
    2280: function (t, e, n) {
      ...
      function _() {
        ...
        function l(t, e, n, a) {
          var o = e && e.prototype instanceof f ? e : f,
            ...
            c = new N(a || []);
          return r(i, "_invoke", { value: E(t, n, c) }), i;
        }
        function s(t, e, n) {
          try {
        ...
        function x(t, e) {
          ...
          if ("throw" === a.type)
            return (
              (e.method = "throw"), (e.arg = a.arg), (e.delegate = null), h
            );
          var o = a.arg;
          return o
            ? o.done
      ...
      var S = (function (t) {
        ...
        function n(t) {
          ...
          return (
            Object(i.a)(this, n),
            ((r = e.call(this, t)).changeHandler = function (t) {
              r.setState(Object(o.a)({}, t.target.name, t.target.value));
            }),
            (r.handleremove = function (t) {
              var e = Object(a.a)(r.state.inputlist);
              e.splice(t, 1), r.setState({ inputlist: e });
            }),
            (r.handleinputchange = function (t, e) {
              var n = t.target,
                o = n.name,
                i = n.value,
                c = Object(a.a)(r.state.inputlist);
              (c[e][o] = i),
                r.setState({ inputlist: c }),
                console.log(r.state.inputlist);
            }),
            (r.handleClick = function () {
              r.setState({
                inputlist: [].concat(Object(a.a)(r.state.inputlist), [
                  { selected: r.state.myvalue, attribute: "", quantity: "" },
                ]),
              });
            }),
            (r.submitHandler = function (t) {
              t.preventDefault(),
                E.a
                  .post("/admin/addorder", r.state)
                  .then(function (t) {
                    console.log(t.data.data),
                      N()("Success!", "Submitted SuccessFull!", "success"),
                        ...
                        switch ((t.prev = t.next)) {
                          case 0:
                            E.a
                              ...
                              .then(function (t) {
                                e.setState({ productName: t.data.data });
                              })
                              .catch(function (t) {
                                console.log(t);
                              }),
                              E.a
                                ...
                                .then(function (t) {
                                  e.setState({ attribuName: t.data.data });
                                })
                                .catch(function (t) {
                          ...
                          render: function (t) {
                            ...
                            return h.a.createElement(
                              m.a,
                              {
                                ...
                                onClick: function () {
                                  return e.push("/app/freshlist/order/all");
                                },
                              },
                              "Back"
                            );
                        ...
                        h.a.createElement(
                          ...
                          h.a.createElement(
                            ...
                            h.a.createElement(
                              g.a,
                              null,
                              h.a.createElement(b.a, null, "Mobile Number"),
                          ...
                          h.a.createElement(
                            d.a,
                            { lg: "6", md: "6" },
                            h.a.createElement(b.a, null, "Notify by "),
                            h.a.createElement(L.a, {
                              ...
                              onSelect: function (e) {
                                t.setState({ notify: e }), console.log(e);
                              },
...
//# sourceMappingURL=203.1a6e1286.chunk.js.map
