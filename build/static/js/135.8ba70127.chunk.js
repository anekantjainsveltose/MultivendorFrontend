          ...
          function t(e) {
            ...
            return (
              ...
              (l.submitHandler = function (e) {
                ...
                var i = l.props.match.params.id;
                E.a
                  .post("/admin/edit_brand/".concat(i), a)
                  .then(function (e) {
                    console.log(e),
            ...
            Object(l.a)(t, [
              {
                ...
                value: function () {
                  ...
                  E.a
                    .get("/admin/viewone_brand/".concat(a))
                    .then(function (a) {
                      console.log(a.data.data),
                        e.setState({
                          data: a.data.data,
                          name: a.data.data.brand_name,
...
//# sourceMappingURL=135.8ba70127.chunk.js.map
