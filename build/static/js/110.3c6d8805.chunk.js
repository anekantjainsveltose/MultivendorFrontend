      ...
      var n = a(837),
        ...
        S = (function (e) {
          ...
          function a(e) {
            ...
            return (
              Object(r.a)(this, a),
              ((s = t.call(this, e)).onChangeHandler1 = function (e) {
                s.setState({ selectedFile1: e.target.files[0] }),
                  s.setState({ selectedName1: e.target.files[0].name }),
                  console.log(e.target.files[0]);
              }),
              (s.onChangeHandler2 = function (e) {
                s.setState({ selectedFile2: e.target.files[0] }),
                  s.setState({ selectedName2: e.target.files[0].name }),
                  console.log(e.target.files[0]);
              }),
              (s.onChangeHandler3 = function (e) {
                s.setState({ selectedFile3: e.target.files[0] }),
                  s.setState({ selectedName3: e.target.files[0].name }),
                  console.log(e.target.files[0]);
              }),
              (s.onChangeHandler4 = function (e) {
                s.setState({ selectedFile4: e.target.files[0] }),
                  s.setState({ selectedName4: e.target.files[0].name }),
                  console.log(e.target.files[0]);
              }),
              ...
              (s.submitHandler = function (e) {
                e.preventDefault();
                var t = new FormData();
                t.append("category_name", s.state.category_name),
                  t.append("type", s.state.type),
                  t.append("feature", s.state.feature),
                  t.append("status", s.state.status),
                  t.append(
                    "image",
                    s.state.selectedFile1,
                    s.state.selectedName1
                  ),
                  t.append(
                    "thumbnail_img",
                    s.state.selectedFile2,
                    s.state.selectedName2
                  ),
                  t.append(
                    "web_banner",
                    s.state.selectedFile3,
                    s.state.selectedName3
                  ),
                  t.append(
                    "app_banner",
                    s.state.selectedFile4,
                    s.state.selectedName4
                  );
                var a,
            ...
            (a.render = function () {
              ...
              g
                ...
                b.size &&
                  ...
                  (s = b.size),
                  delete b.size);
              var O = Object(f.mapToCssModules)(
                d()(
                  t,
                  i && "is-invalid",
                  c && "is-valid",
          ...
          return (
            ...
            (a.render = function () {
              var e = this.props,
                ...
                c = e.innerRef,
                i = Object(l.a)(e, p),
                u = Object(f.mapToCssModules)(d()(t, !!r && "form-inline"), a);
      ...
      var n = a(6),
        ...
        y = function (e) {
          ...
          return s.a.createElement(
            o,
            Object(n.a)({ htmlFor: p }, g, { className: y })
          );
        };
    ...
    841: function (e, t, a) {
      ...
      var n = a(6),
        ...
        p = function (e) {
          ...
          return (
            "fieldset" === f && (p.disabled = c),
            s.a.createElement(f, Object(n.a)({}, p, { className: g }))
          );
        };
...
//# sourceMappingURL=110.3c6d8805.chunk.js.map
