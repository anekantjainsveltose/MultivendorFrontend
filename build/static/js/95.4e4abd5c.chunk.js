<<<<<<< HEAD:build/static/js/95.413a3884.chunk.js
      ...
      var n = t(837),
        ...
        S = (function (e) {
          ...
          function t(e) {
            ...
            return (
              Object(r.a)(this, t),
              ((c = a.call(this, e)).onChangeHandler1 = function (e) {
                c.setState({ selectedFile1: e.target.files[0] }),
                  c.setState({ selectedName1: e.target.files[0].name }),
                  console.log(e.target.files[0]);
              }),
              (c.onChangeHandler2 = function (e) {
                c.setState({ selectedFile2: e.target.files[0] }),
                  c.setState({ selectedName2: e.target.files[0].name }),
                  console.log(e.target.files[0]);
              }),
              (c.onChangeHandler3 = function (e) {
                c.setState({ selectedFile3: e.target.files[0] }),
                  c.setState({ selectedName3: e.target.files[0].name }),
                  console.log(e.target.files[0]);
              }),
              (c.onChangeHandler4 = function (e) {
                c.setState({ selectedFile4: e.target.files[0] }),
                  c.setState({ selectedName4: e.target.files[0].name }),
                  console.log(e.target.files[0]);
              }),
              (c.onChangeHandler5 = function (e) {
                c.setState({ selectedFile5: e.target.files[0] }),
                  c.setState({ selectedName5: e.target.files[0].name }),
                  console.log(e.target.files[0]);
              }),
              (c.onChangeHandler6 = function (e) {
                c.setState({ selectedFile6: e.target.files[0] }),
                  c.setState({ selectedName6: e.target.files[0].name }),
                  console.log(e.target.files[0]);
              }),
              ...
              (c.submitHandler = function (e) {
                e.preventDefault();
                var a = new FormData();
                a.append("name", c.state.name),
                  a.append("mobile", c.state.mobile),
                  a.append("email", c.state.email),
                  a.append("door_number", c.state.door_number),
                  a.append("street", c.state.street),
                  a.append("location", c.state.location),
                  a.append("city", c.state.city),
                  a.append("pincode", c.state.pincode),
                  a.append("service_location", c.state.service_location),
                  a.append("service_city", c.state.service_city),
                  a.append("service_pincode", c.state.service_pincode),
                  a.append("adhar_no", c.state.adhar_no),
                  a.append("pancard_no", c.state.pancard_no),
                  a.append("account_no", c.state.account_no),
                  a.append("cus_name", c.state.cus_name),
                  a.append("branch", c.state.branch),
                  a.append("ifsc_code", c.state.ifsc_code),
                  a.append(
                    "vendoor_img",
                    c.state.selectedFile1,
                    c.state.selectedName1
                  ),
                  a.append(
                    "adhar_img_front",
                    c.state.selectedFile2,
                    c.state.selectedName2
                  ),
                  a.append(
                    "adhar_img_back",
                    c.state.selectedFile3,
                    c.state.selectedName3
                  ),
                  a.append(
                    "pancard_img_front",
                    c.state.selectedFile4,
                    c.state.selectedName4
                  ),
                  a.append(
                    "pancard_img_back",
                    c.state.selectedFile5,
                    c.state.selectedName5
                  ),
                  a.append(
                    "passbook_img",
                    c.state.selectedFile6,
                    c.state.selectedName6
                  );
                var t,
                ...
                N.a
                  .post("/admin/admin_add_vender", a)
                  .then(function (e) {
                    console.log(e.data),
                      "success" === e.data.msg &&
                        (C()("Success!", "Submitted SuccessFull!", "success"),
                        ...
                        m.a.createElement(
                          ...
                          m.a.createElement(
                            ...
                            m.a.createElement(
                              ...
                              m.a.createElement(b.a, null, "Mobile No."),
                              m.a.createElement(E.a, {
                                required: !0,
                                type: "number",
                                name: "mobile",
                            ...
                            m.a.createElement(
                              h.a,
                              { lg: "6", md: "6", className: "mb-1" },
                              m.a.createElement(b.a, null, "Door Number"),
                              m.a.createElement(E.a, {
                                required: !0,
                                type: "text",
                                name: "door_number",
                            ...
                            m.a.createElement(
                              h.a,
                              { lg: "6", md: "6", className: "mb-1" },
                              m.a.createElement(b.a, null, "Street"),
                              m.a.createElement(E.a, {
                                required: !0,
                                type: "text",
                                name: "street",
                            ...
                            m.a.createElement(
                              h.a,
                              { lg: "6", md: "6", className: "mb-1" },
                              m.a.createElement(b.a, null, "Location"),
                              m.a.createElement(E.a, {
                                required: !0,
                                type: "text",
                                name: "location",
                            ...
                            m.a.createElement(
                              h.a,
                              { lg: "6", md: "6", className: "mb-1" },
                              m.a.createElement(b.a, null, "PinCode"),
                              m.a.createElement(E.a, {
                                required: !0,
                                type: "tel",
                                name: "pincode",
                          ...
                          m.a.createElement(
                            u.a,
                            null,
                            m.a.createElement("h5", null, "Service Information")
                          ),
                          m.a.createElement(
                            u.a,
                            { className: "mb-2 mt-2" },
                            m.a.createElement(
                              h.a,
                              { lg: "6", md: "6", className: "mb-1" },
                              m.a.createElement(b.a, null, "Service Location"),
                              m.a.createElement(E.a, {
                                required: !0,
                                type: "text",
                            ...
                            m.a.createElement(
                              h.a,
                              { lg: "6", md: "6", className: "mb-1" },
                              m.a.createElement(b.a, null, "Service City"),
                              m.a.createElement(E.a, {
                                required: !0,
                                type: "text",
                                name: "service_city",
                            ...
                            m.a.createElement(
                              h.a,
                              { lg: "6", md: "6", className: "mb-1" },
                              m.a.createElement(b.a, null, "Service PinCode"),
                              m.a.createElement(E.a, {
                                required: !0,
                                type: "number",
                          ...
                          m.a.createElement(
                            u.a,
                            null,
                            m.a.createElement("h5", null, " Document Details")
                          ),
                          m.a.createElement(
                            u.a,
                            { className: "mb-2 mt-2" },
                            m.a.createElement(
                              h.a,
                              { lg: "6", md: "6", className: "mb-1" },
                              m.a.createElement(b.a, null, "Vendor Image"),
                            ...
                            m.a.createElement(
                              h.a,
                              { lg: "6", md: "6", className: "mb-1" },
                              m.a.createElement(b.a, null, "Aadhar Number"),
                              m.a.createElement(E.a, {
                                required: !0,
                                type: "number",
                                name: "adhar_no",
                            ...
                            m.a.createElement(
                              h.a,
                              { lg: "6", md: "6", className: "mb-1" },
                              m.a.createElement(b.a, null, "Aadhar Back Image"),
                              m.a.createElement(v.a, {
                                required: !0,
                                type: "file",
                            ...
                            m.a.createElement(
                              h.a,
                              { lg: "6", md: "6", className: "mb-1" },
                              m.a.createElement(b.a, null, "PAN Card Number"),
                              m.a.createElement(E.a, {
                                required: !0,
                                type: "text",
                                name: "pancard_no",
                            ...
                            m.a.createElement(
                              h.a,
                              { lg: "6", md: "6", className: "mb-1" },
                              m.a.createElement(b.a, null, "Account Number"),
                              m.a.createElement(E.a, {
                                required: !0,
                                type: "text",
                                name: "account_no",
                            ...
                            m.a.createElement(
                              h.a,
                              { lg: "6", md: "6", className: "mb-1" },
                              m.a.createElement(b.a, null, "Branch Name"),
                              m.a.createElement(E.a, {
                                required: !0,
                                type: "text",
                                name: "branch",
                            ...
                            m.a.createElement(
                              h.a,
                              { lg: "6", md: "6", className: "mb-1" },
                              m.a.createElement(b.a, null, "IFSC Code"),
                              m.a.createElement(E.a, {
                                required: !0,
                                type: "text",
                                name: "ifsc_code",
          ...
          return (
            ...
            (t.render = function () {
              var e = this.props,
                ...
                v = new RegExp("\\D", "g"),
                N = m || ("select" === r || "textarea" === r ? r : "input"),
                y = "form-control";
              f
                ? ((y += "-plaintext"), (N = m || "input"))
                : "file" === r
                ? (y += "-file")
                : "range" === r
                ? (y += "-range")
                : E && (y = d ? null : "form-check-input"),
                b.size &&
                  v.test(b.size) &&
                  (Object(h.warnOnce)(
                  ...
                  (c = b.size),
                  delete b.size);
              var C = Object(h.mapToCssModules)(
                u()(
                  a,
                  o && "is-invalid",
                  s && "is-valid",
          ...
          return (
            ...
            (t.render = function () {
              var e = this.props,
                ...
                s = e.innerRef,
                o = Object(l.a)(e, p),
                m = Object(h.mapToCssModules)(u()(a, !!r && "form-inline"), t);
      ...
      var n = t(6),
        ...
        E = function (e) {
                ...
                (r = b(c, a, l.size)),
                  g.push(
                    Object(d.mapToCssModules)(
                      m()(
                        (((s = {})[r] = l.size || "" === l.size),
                        (s["order" + i + l.order] = l.order || 0 === l.order),
                        (s["offset" + i + l.offset] =
                          l.offset || 0 === l.offset),
                        s)
                      )
          ...
          return c.a.createElement(
            i,
            Object(n.a)({ htmlFor: p }, f, { className: E })
          );
        };
