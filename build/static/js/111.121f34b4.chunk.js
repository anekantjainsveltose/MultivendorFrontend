          ...
          function a(e) {
            ...
            return (
              ...
              (r.submitHandler = function (e) {
                e.preventDefault();
                var t = new FormData();
                t.append("category_name", r.state.category_name),
                ...
                console.log(c),
                  N.a
                    .post("/admin/edit_category/".concat(c), t)
                    .then(function (e) {
                      console.log(e),
                        "success" === e.data.msg &&
                          (C()(
                            "Success!",
                            "You Data IS been Submitted",
                            "success"
                          ),
            ...
            Object(r.a)(a, [
              {
                ...
                value: function () {
                  ...
                  N.a
                    .get("/admin/viewonecategory/".concat(t))
                    .then(function (t) {
                      console.log(t.data.data),
                        e.setState({
                          data: t.data.data,
                          category_name: t.data.data.category_name,
...
//# sourceMappingURL=111.121f34b4.chunk.js.map
