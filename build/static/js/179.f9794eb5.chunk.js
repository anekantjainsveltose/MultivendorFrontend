/*! For license information please see 179.f9794eb5.chunk.js.LICENSE.txt */
                      ...
                      for (;;)
                        switch ((e.prev = e.next)) {
                          case 0:
                            return (
                              (e.next = 2),
                              S.a.get("/user/userlist").then(function (e) {
                                var r = e.data.data;
                        ...
                        switch ((e.prev = e.next)) {
                          case 0:
                            return (
                              console.log(t),
                              (e.next = 3),
                              x.a.delete("/user/dlt_user/".concat(t)).then(
                                function (e) {
                                  console.log(e);
                                },
                                function (e) {
...
//# sourceMappingURL=179.f9794eb5.chunk.js.map
