<<<<<<< HEAD:build/static/js/96.6f2471d4.chunk.js
/*! For license information please see 96.6f2471d4.chunk.js.LICENSE.txt */
  ...
  [96],
  {
    2194: function (e, t, a) {
      ...
      function x() {
        ...
        function s(e, t, a, r) {
          var o = t && t.prototype instanceof m ? t : m,
            ...
            c = new O(r || []);
          return n(l, "_invoke", { value: _(e, a, c) }), l;
        }
        function d(e, t, a) {
          try {
        ...
        var g = Object.getPrototypeOf,
          v = g && g(g(j([])));
        v && v !== t && a.call(v, o) && (p = v);
        var b = (f.prototype = m.prototype = Object.create(p));
        function y(e) {
        ...
        function _(e, t, a) {
          ...
          return function (r, o) {
            ...
            for (a.method = r, a.arg = o; ; ) {
              ...
              if ("normal" === i.type) {
                if (
                  ((n = a.done ? "completed" : "suspendedYield"), i.arg === u)
                )
                  continue;
        ...
        return (
          ...
          n(f, "constructor", { value: h, configurable: !0 }),
          (h.displayName = i(f, c, "GeneratorFunction")),
          ...
          (O.prototype = {
            ...
            finish: function (e) {
              for (var t = this.tryEntries.length - 1; t >= 0; --t) {
                ...
                if (a.finallyLoc === e)
                  return this.complete(a.completion, a.afterLoc), C(a), u;
              }
            },
            catch: function (e) {
              for (var t = this.tryEntries.length - 1; t >= 0; --t) {
            ...
            delegateYield: function (e, t, a) {
              return (
                (this.delegate = { iterator: j(e), resultName: t, nextLoc: a }),
      ...
      var O = (function (e) {
        ...
        function a(e) {
          ...
          return (
            Object(l.a)(this, a),
            ((n = t.call(this, e)).onChangeHandler1 = function (e) {
              n.setState({ selectedFile1: e.target.files[0] }),
                n.setState({ selectedName1: e.target.files[0].name }),
                console.log(e.target.files[0]);
            }),
            (n.onChangeHandler2 = function (e) {
              n.setState({ selectedFile2: e.target.files[0] }),
                n.setState({ selectedName2: e.target.files[0].name }),
                console.log(e.target.files[0]);
            }),
            (n.onChangeHandler3 = function (e) {
              n.setState({ selectedFile3: e.target.files[0] }),
                n.setState({ selectedName3: e.target.files[0].name }),
                console.log(e.target.files[0]);
            }),
            (n.onChangeHandler4 = function (e) {
              n.setState({ selectedFile4: e.target.files[0] }),
                n.setState({ selectedName4: e.target.files[0].name }),
                console.log(e.target.files[0]);
            }),
            (n.onChangeHandler5 = function (e) {
              n.setState({ selectedFile5: e.target.files[0] }),
                n.setState({ selectedName5: e.target.files[0].name }),
                console.log(e.target.files[0]);
            }),
            (n.onChangeHandler6 = function (e) {
              n.setState({ selectedFile6: e.target.files[0] }),
                n.setState({ selectedName6: e.target.files[0].name }),
                console.log(e.target.files[0]);
            }),
            (n.changeHandler = function (e) {
              n.setState(Object(o.a)({}, e.target.name, e.target.value));
            }),
            (n.submitHandler = function (e) {
              e.preventDefault();
              var t = new FormData();
              t.append("name", n.state.name),
                t.append("mobile", n.state.mobile),
                t.append("email", n.state.email),
                t.append("door_number", n.state.door_number),
                t.append("street", n.state.street),
                t.append("location", n.state.location),
                t.append("city", n.state.city),
                t.append("pincode", n.state.pincode),
                t.append("service_location", n.state.service_location),
                t.append("service_city", n.state.service_city),
                t.append("service_pincode", n.state.service_pincode),
                t.append("adhar_no", n.state.adhar_no),
                t.append("pancard_no", n.state.pancard_no),
                t.append("account_no", n.state.account_no),
                t.append("cus_name", n.state.cus_name),
                t.append("branch", n.state.branch),
                t.append("ifsc_code", n.state.ifsc_code),
                null !== n.state.selectedFile1 &&
                  t.append(
                    "vendoor_img",
                    n.state.selectedFile1,
                    n.state.selectedName1
                  ),
                null !== n.state.selectedFile2 &&
                  t.append(
                    "adhar_img_front",
                    n.state.selectedFile2,
                    n.state.selectedName2
                  ),
                null !== n.state.selectedFile3 &&
                  t.append(
                    "adhar_img_back",
                    n.state.selectedFile3,
                    n.state.selectedName3
                  ),
                null !== n.state.selectedFile4 &&
                  t.append(
                    "pancard_img_front",
                    n.state.selectedFile4,
                    n.state.selectedName4
                  ),
                null !== n.state.selectedFile5 &&
                  t.append(
                    "pancard_img_back",
                    n.state.selectedFile5,
                    n.state.selectedName5
                  ),
                null !== n.state.selectedFile6 &&
                  t.append(
                    "passbook_img",
                    n.state.selectedFile6,
                    n.state.selectedName6
                  );
              var a,
                o = Object(r.a)(t.values());
              try {
                for (o.s(); !(a = o.n()).done; ) {
                  var l = a.value;
                  console.log(l);
              ...
              var d = n.props.match.params.id;
              _.a
                .post("/admin/edit_admin_vender/".concat(d), t)
                .then(function (e) {
                  console.log(e.data),
                    "success" === e.data.msg &&
                      (w()("Success!", "Submitted SuccessFull!", "success"),
                      n.props.history.push("/app/freshlist/vendor/vendorList"));
                })
                .catch(function (e) {
                  console.log(e);
                });
                          ...
                          switch ((e.prev = e.next)) {
                            case 0:
                              (t = this.props.match.params.id),
                                console.log("vendor id ", t),
                                _.a
                                  .get("/app/vender_getviewone/".concat(t))
                                  .then(function (e) {
                                    console.log(e.data.data),
                                      a.setState({
                                        ...
                                        door_number: e.data.data.door_number,
                                        street: e.data.data.street,
                                        location: e.data.data.location,
                                        city: e.data.data.city,
                                        pincode: e.data.data.pincode,
                                        service_location:
                                          e.data.data.service_location,
                                        service_city: e.data.data.service_city,
                                        service_pincode:
                                          e.data.data.service_pincode,
                                        adhar_no: e.data.data.adhar_no,
                                        pancard_no: e.data.data.pancard_no,
                                        account_no: e.data.data.account_no,
                                        cus_name: e.data.data.cus_name,
                                        branch: e.data.data.branch,
                                        ifsc_code: e.data.data.ifsc_code,
                                      });
                                  })
                                  .catch(function (e) {
                                    console.log(e);
                    ...
                    u.a.createElement(
                      ...
                      u.a.createElement(
                        ...
                        u.a.createElement(
                          h.a,
                          null,
                          u.a.createElement("h5", null, "Personal Information")
                        ),
                        u.a.createElement(
                          h.a,
                          { className: "mb-2 mt-2" },
                          u.a.createElement(
                            ...
                            u.a.createElement(b.a, null, "Name"),
                          ...
                          u.a.createElement(
                            ...
                            u.a.createElement(b.a, null, "Mobile No."),
                            u.a.createElement(y.a, {
                              type: "number",
                              name: "mobile",
                          ...
                          u.a.createElement(
                            f.a,
                            { lg: "6", md: "6", className: "mb-1" },
                            u.a.createElement(b.a, null, "Email"),
                            u.a.createElement(y.a, {
                              type: "email",
                              name: "email",
                          ...
                          u.a.createElement(
                            f.a,
                            { lg: "6", md: "6", className: "mb-1" },
                            u.a.createElement(b.a, null, "Door Number"),
                            u.a.createElement(y.a, {
                              type: "text",
                              name: "door_number",
                          ...
                          u.a.createElement(
                            f.a,
                            { lg: "6", md: "6", className: "mb-1" },
                            u.a.createElement(b.a, null, "Street"),
                            u.a.createElement(y.a, {
                              type: "text",
                              name: "street",
                              placeholder: "Street",
                          ...
                          u.a.createElement(
                            f.a,
                            { lg: "6", md: "6", className: "mb-1" },
                            u.a.createElement(b.a, null, "Location"),
                            u.a.createElement(y.a, {
                              type: "text",
                              name: "location",
                          ...
                          u.a.createElement(
                            f.a,
                            { lg: "6", md: "6", className: "mb-1" },
                            u.a.createElement(b.a, null, "City"),
                            u.a.createElement(y.a, {
                              type: "text",
                              name: "city",
                              placeholder: "City",
                          ...
                          u.a.createElement(
                            f.a,
                            { lg: "6", md: "6", className: "mb-1" },
                            u.a.createElement(b.a, null, "PinCode"),
                            u.a.createElement(y.a, {
                              type: "tel",
                              name: "pincode",
                              placeholder: "PINCODE",
                        ...
                        u.a.createElement(
                          h.a,
                          null,
                          u.a.createElement("h5", null, "Service Information")
                        ),
                        u.a.createElement(
                          h.a,
                          { className: "mb-2 mt-2" },
                          u.a.createElement(
                            f.a,
                            { lg: "6", md: "6", className: "mb-1" },
                            u.a.createElement(b.a, null, "Service Location"),
                            u.a.createElement(y.a, {
                              type: "text",
                          ...
                          u.a.createElement(
                            f.a,
                            { lg: "6", md: "6", className: "mb-1" },
                            u.a.createElement(b.a, null, "Service City"),
                            u.a.createElement(y.a, {
                              type: "text",
                              name: "service_city",
                          ...
                          u.a.createElement(
                            f.a,
                            { lg: "6", md: "6", className: "mb-1" },
                            u.a.createElement(b.a, null, "Service PinCode"),
                            u.a.createElement(y.a, {
                              type: "number",
                        ...
                        u.a.createElement(
                          h.a,
                          null,
                          u.a.createElement("h5", null, " Document Details")
                        ),
                        u.a.createElement(
                          h.a,
                          { className: "mb-2 mt-2" },
                          u.a.createElement(
                            f.a,
                            { lg: "6", md: "6", className: "mb-1" },
                            u.a.createElement(b.a, null, "Vendor Image"),
                          ...
                          u.a.createElement(
                            f.a,
                            { lg: "6", md: "6", className: "mb-1" },
                            u.a.createElement(b.a, null, "Aadhar Number"),
                            u.a.createElement(y.a, {
                              type: "number",
                              name: "adhar_no",
                          ...
                          u.a.createElement(
                            f.a,
                            { lg: "6", md: "6", className: "mb-1" },
                            u.a.createElement(b.a, null, "Aadhar Front Image"),
                            u.a.createElement(E.a, {
                              type: "file",
                          ...
                          u.a.createElement(
                            f.a,
                            { lg: "6", md: "6", className: "mb-1" },
                            u.a.createElement(b.a, null, "Aadhar Back Image"),
                            u.a.createElement(E.a, {
                              type: "file",
                          ...
                          u.a.createElement(
                            f.a,
                            { lg: "6", md: "6", className: "mb-1" },
                            u.a.createElement(b.a, null, "PAN Card Number"),
                            u.a.createElement(y.a, {
                              type: "text",
                              name: "pancard_no",
                          ...
                          u.a.createElement(
                            f.a,
                            { lg: "6", md: "6", className: "mb-1" },
                            u.a.createElement(b.a, null, "PAN Card Back Image"),
                            u.a.createElement(E.a, {
                              type: "file",
                          ...
                          u.a.createElement(
                            f.a,
                            { lg: "6", md: "6", className: "mb-1" },
                            u.a.createElement(b.a, null, "Account Number"),
                            u.a.createElement(y.a, {
                              type: "text",
                              name: "account_no",
                          ...
                          u.a.createElement(
                            f.a,
                            { lg: "6", md: "6", className: "mb-1" },
                            u.a.createElement(b.a, null, "Account Holder Name"),
                            u.a.createElement(y.a, {
                              type: "text",
                              name: "cus_name",
                          ...
                          u.a.createElement(
                            f.a,
                            { lg: "6", md: "6", className: "mb-1" },
                            u.a.createElement(b.a, null, "Branch Name"),
                            u.a.createElement(y.a, {
                              type: "text",
                              name: "branch",
                          ...
                          u.a.createElement(
                            f.a,
                            { lg: "6", md: "6", className: "mb-1" },
                            u.a.createElement(b.a, null, "IFSC Code"),
                            u.a.createElement(y.a, {
                              type: "text",
                              name: "ifsc_code",
          ...
          return (
            ...
            (a.render = function () {
              var e = this.props,
                ...
                g = e.innerRef,
                v = Object(r.a)(e, f),
                b = ["radio", "checkbox"].indexOf(o) > -1,
                y = new RegExp("\\D", "g"),
                E = d || ("select" === o || "textarea" === o ? o : "input"),
                _ = "form-control";
              p
                ? ((_ += "-plaintext"), (E = d || "input"))
                : "file" === o
                ? (_ += "-file")
                : "range" === o
                ? (_ += "-range")
                : b && (_ = u ? null : "form-check-input"),
                v.size &&
                  y.test(v.size) &&
                  (Object(h.warnOnce)(
          ...
          return (
            ...
            (a.render = function () {
              var e = this.props,
                ...
                c = e.innerRef,
                s = Object(r.a)(e, f),
                d = Object(h.mapToCssModules)(m()(t, !!o && "form-inline"), a);
              return i.a.createElement(
                l,
                Object(n.a)({}, s, { ref: c, className: d })
              );
            }),
            t
          );
    ...
    835: function (e, t, a) {
      ...
      var n = a(6),
        ...
        h = i.a.oneOfType([i.a.number, i.a.string]),
        f = i.a.oneOfType([
          i.a.bool,
          i.a.string,
          i.a.number,
          i.a.shape({ size: h, order: h, offset: h }),
        ]),
        p = {
          children: i.a.node,
          hidden: i.a.bool,
        ...
        b = function (e) {
          ...
          c.forEach(function (t, n) {
            ...
            if ((delete p[t], r || "" === r)) {
                ...
                (o = v(l, t, r.size)),
                  g.push(
                    Object(u.mapToCssModules)(
                      d()(
                        (((c = {})[o] = r.size || "" === r.size),
                        (c["order" + i + r.order] = r.order || 0 === r.order),
                        (c["offset" + i + r.offset] =
                          r.offset || 0 === r.offset),
                        c)
                      )
              ...
              } else (o = v(l, t, r)), g.push(o);
            }
          });
          var b = Object(u.mapToCssModules)(
            d()(
              t,
              !!o && "sr-only",
              !!s && "form-check-label",
          ...
          return l.a.createElement(
            i,
            Object(n.a)({ htmlFor: f }, p, { className: b })
          );
        };
